...
# (To use Postgres instead: set `config :vox, ecto_adapter: Ecto.Adapters.Postgres`
...
config :vox, VoxWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "OsgJSEWMxiejulouR6p2aeQbmGdvuspZAHUlI8onWbMfwTDiPQ1qhlxC0jqPP+S/",
  watchers: []
